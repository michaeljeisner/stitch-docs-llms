...
This repository publishes an `llms.txt` artifact generated from the accessible rendered documentation at https://stitch.withgoogle.com/docs.
...
- [`llms.txt`](./llms.txt): the generated Markdown documentation artifact.
